...
TEST_F(TestLoadOpticsFileFromDisk, TestLoadClear3)
{
	...
	EXPECT_EQ(givenResults[0].directComponent.tf, 0.002);
	EXPECT_EQ(givenResults[0].directComponent.rf, 0.047);
	EXPECT_EQ(givenResults[0].directComponent.rb, 0.048);
	EXPECT_EQ(givenResults[110].wavelength, 2.5);
	EXPECT_EQ(givenResults[110].directComponent.tf, 0.822);
	EXPECT_EQ(givenResults[110].directComponent.rf, 0.068);
...
TEST_F(TestLoadOpticsFileFromDisk, TestLoadDiffuseData)
{
	...
	EXPECT_EQ(givenMeasurements[0].directComponent.tf, 0.001);
	EXPECT_EQ(givenMeasurements[0].directComponent.tb, 0.006);
	EXPECT_EQ(givenMeasurements[0].directComponent.rf, 0.011);
	EXPECT_EQ(givenMeasurements[0].directComponent.rb, 0.006);
	...
	EXPECT_EQ(givenMeasurements[450].directComponent.tf, 0.520);
	EXPECT_EQ(givenMeasurements[450].directComponent.tb, 0.528);
	EXPECT_EQ(givenMeasurements[450].directComponent.rf, 0.000);
	EXPECT_EQ(givenMeasurements[450].directComponent.rb, 0.000);
