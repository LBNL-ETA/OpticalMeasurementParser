...
TEST_F(TestLoadOpticsFileFromDisk, TestLoadClear3)
{
    ...
    EXPECT_EQ(product->measurements.value()[0].directComponent.tf, 0.002);
    EXPECT_EQ(product->measurements.value()[0].directComponent.rf, 0.047);
    EXPECT_EQ(product->measurements.value()[0].directComponent.rb, 0.048);
    EXPECT_EQ(product->measurements.value()[110].wavelength, 2.5);
    EXPECT_EQ(product->measurements.value()[110].directComponent.tf, 0.822);
    EXPECT_EQ(product->measurements.value()[110].directComponent.rf, 0.068);
    EXPECT_EQ(product->measurements.value()[110].directComponent.rb, 0.068);
...
TEST_F(TestLoadOpticsFileFromDisk, TestLoadDiffuseData)
{
    ...
    EXPECT_EQ(product->measurements.value().size(), 451);
    EXPECT_EQ(product->measurements.value()[0].wavelength, 0.250);
    EXPECT_EQ(product->measurements.value()[0].directComponent.tf, 0.001);
    EXPECT_EQ(product->measurements.value()[0].directComponent.tb, 0.006);
    EXPECT_EQ(product->measurements.value()[0].directComponent.rf, 0.011);
    EXPECT_EQ(product->measurements.value()[0].directComponent.rb, 0.006);
    EXPECT_EQ(product->measurements.value()[0].diffuseComponent.value().tf, 0.002);
    EXPECT_EQ(product->measurements.value()[0].diffuseComponent.value().tb, 0.076);
    EXPECT_EQ(product->measurements.value()[0].diffuseComponent.value().rf, 0.087);
    EXPECT_EQ(product->measurements.value()[0].diffuseComponent.value().rb, 0.131);
    EXPECT_EQ(product->measurements.value()[450].wavelength, 2.5);
    EXPECT_EQ(product->measurements.value()[450].directComponent.tf, 0.520);
    EXPECT_EQ(product->measurements.value()[450].directComponent.tb, 0.528);
    EXPECT_EQ(product->measurements.value()[450].directComponent.rf, 0.000);
    EXPECT_EQ(product->measurements.value()[450].directComponent.rb, 0.000);
    EXPECT_EQ(product->measurements.value()[450].diffuseComponent.value().tf, 0.238);
    EXPECT_EQ(product->measurements.value()[450].diffuseComponent.value().tb, 0.240);
    EXPECT_EQ(product->measurements.value()[450].diffuseComponent.value().rf, 0.0970);
    EXPECT_EQ(product->measurements.value()[450].diffuseComponent.value().rb, 0.0940);
