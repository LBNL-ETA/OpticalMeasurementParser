...
macro(ADD_GOOGLE_TESTS_PAR executable)
  foreach ( source ${ARGN} )
...
macro( CREATE_SRC_GROUPS_PAR SRC )
  foreach( F ${SRC} )
...
# Create test targets
macro( CREATE_TEST_TARGETS_PAR BASE_NAME SRC DEPENDENCIES )
  if( BUILD_PAR_TESTING )
    ...
    ADD_GOOGLE_TESTS_PAR( ${BASE_NAME}_tests ${SRC} )
  endif()
endmacro()
